...
Public Class Load_Simple_E57
    Inherits GH_Component

    Sub New()
        MyBase.New("Simple E57", "SimpleE57", "Loads selected scans from E57 file", "Volvox", "E57")
    End Sub

    Public Overrides ReadOnly Property ComponentGuid As Guid
        Get
            Return New Guid("6af6a184-a419-46c9-8534-13b1b2959c8c")
        End Get
    End Property
    ...
    Protected Overrides Sub RegisterOutputParams(pManager As GH_OutputParamManager)
        pManager.AddParameter(New Param_Cloud, "Cloud", "Cloud", "Loaded Cloud", GH_ParamAccess.list)
        pManager.AddPlaneParameter("Position", "Position", "Scan pose", GH_ParamAccess.list)
        pManager.AddTextParameter("Guid", "Guid", "Guid", GH_ParamAccess.list)
        pManager.AddTextParameter("Name", "Name", "Scan name", GH_ParamAccess.list)
    End Sub
    ...
    Protected Overrides Sub SolveInstance(DA As IGH_DataAccess)
        ...
        Dim guidL As New List(Of String)
        Dim nameL As New List(Of String)

        For Each int As Integer In il
            Dim thisScan As Scan = doc.Scans(int)

            guidL.Add(thisScan.GUID.ToString)
            nameL.Add(thisScan.Name)
            ...
            pc.Transform(thisrotation)
            pc.Transform(thistrans)
        ...
        DA.SetDataList(2, guidL)
        DA.SetDataList(3, nameL)
